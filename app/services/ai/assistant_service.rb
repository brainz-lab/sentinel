...
module Ai
  class AssistantService
    ...
    def build_tools
      Mcp::ToolsController::TOOLS.map do |name, tool_class|
    ...
    def system_prompt
      "You are an AI assistant for Sentinel, the security monitoring and compliance system. You help users manage alert rules, review security events, track compliance status, and investigate incidents."
    end
    ...
    def execute_tool(name, arguments)
      tool_class = Mcp::ToolsController::TOOLS[name]
